...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .cube-btn
    ...
    &.cube-btn_disabled:active
      ...
      border-1px($btn-disabled-bdc, $btn-radius)
  ...
  .cube-btn-primary
    ...
    border-1px($btn-primary-bdc, $btn-radius)
  ...
  .cube-btn-outline
    ...
    border-1px($btn-outline-bdc, $btn-radius)
  ...
  .cube-btn-outline-primary
    ...
    border-1px($btn-outline-primary-bdc, $btn-radius)
